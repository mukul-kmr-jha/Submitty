...
class Course extends AbstractModel {
    ...
    /** @property @var string the semester (or term) code in which the course is taking place. */
    protected $semester;
    /** @property @var string the name of the semester (or term). aka "Long Semester". */
